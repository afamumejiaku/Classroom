          ...
          parse: function parse(text, path) {
            ...
            function parseNodeInstance(xml) {
              ...
              for (var i = 0; i < xml.childNodes.length; i++) {
                ...
                switch (child.nodeName) {
                  case 'bind_material':
                    var instances = child.getElementsByTagName(
                      'instance_material'
                    )
      ...
      function (require, module, exports) {
        ...
        module.exports = THREE.FBXLoader = (function () {
          ...
          FBXTreeParser.prototype = {
            ...
            parseParameters: function parseParameters(
              materialNode,
              textureMap,
              ID
            ) {
              ...
              connections.get(ID).children.forEach(function (child) {
                ...
                switch (type) {
                  ...
                  case 'DisplacementColor':
                    parameters.displacementMap = self.getTexture(
                      textureMap,
                      child.ID
                    )
                    break
                  ...
                  case 'EmissiveColor':
                    parameters.emissiveMap = self.getTexture(
                      textureMap,
                      child.ID
                    )
                    break
                  ...
                  case 'SpecularColor':
                    parameters.specularMap = self.getTexture(
                      textureMap,
                      child.ID
                    )
                    break
              ...
              if ('Deformer' in fbxTree.Objects) {
                ...
                for (var nodeID in DeformerNodes) {
                  ...
                  if (deformerNode.attrType === 'Skin') {
                    var skeleton = this.parseSkeleton(
                      relationships,
                      DeformerNodes
                    )
                    skeleton.ID = nodeID
            ...
            parseMorphTargets: function parseMorphTargets(
              relationships,
              deformerNodes
            ) {
              var rawMorphTargets = []
            ...
            parseModels: function parseModels(
              ...
              for (var nodeID in modelNodes) {
                ...
                if (!model) {
                  ...
                  model.name = THREE.PropertyBinding.sanitizeNodeName(
                    node.attrName
                  )
                  model.ID = id
                }
            ...
            buildSkeleton: function buildSkeleton(
              relationships,
              skeletons,
              id,
              name
            ...
            createCurve: function createCurve(relationships, geometryMap) {
              var geometry = relationships.children.reduce(function (
                geo,
                child
              ) {
            ...
            setModelTransforms: function setModelTransforms(model, modelNode) {
              ...
              if ('RotationOrder' in modelNode)
                transformData.eulerOrder = parseInt(
            ...
            setLookAtProperties: function setLookAtProperties(
              model,
              modelNode
            ) {
            ...
            bindSkeleton: function bindSkeleton(
              skeletons,
              geometryMap,
              modelMap
            ) {
                  ...
                  if (BindPoseNode[nodeID].attrType === 'BindPose') {
                    ...
                    if (Array.isArray(poseNodes)) {
                      poseNodes.forEach(function (poseNode) {
                        bindMatrices[
                          poseNode.Node
                        ] = new THREE.Matrix4().fromArray(poseNode.Matrix.a)
                      })
                    } else {
                      bindMatrices[
                        poseNodes.Node
                      ] = new THREE.Matrix4().fromArray(poseNodes.Matrix.a)
                    }
                  }
                }
              }
              ...
              sceneGraph.traverse(function (child) {
                if (child.isMesh) {
                  if (
                    ...
                    child.geometry.morphAttributes.normal
                  ) {
                    var uuid = child.uuid
          ...
          GeometryParser.prototype = {
            ...
            parseGeometry: function parseGeometry(
              relationships,
              geoNode,
              deformers
            ) {
            ...
            parseMeshGeometry: function parseMeshGeometry(
              relationships,
              geoNode,
              deformers
            ) {
              ...
              var skeleton = relationships.children.reduce(function (
                skeleton,
                child
              ) {
              ...
              if ('RotationOrder' in modelNode)
                transformData.eulerOrder = modelNode.RotationOrder.value
            ...
            genGeometry: function genGeometry(
              geoNode,
              skeleton,
              morphTarget,
              preTransform
            ...
            addMorphTargets: function addMorphTargets(
              parentGeo,
              parentGeoNode,
              morphTarget,
              preTransform
            ...
            genMorphGeometry: function genMorphGeometry(
              parentGeo,
              parentGeoNode,
              morphGeoNode,
              preTransform
            ...
            parseNurbsGeometry: function parseNurbsGeometry(geoNode) {
              ...
              for (var i = 0, l = pointsValues.length; i < l; i += 4) {
                controlPoints.push(
                  new THREE.Vector4().fromArray(pointsValues, i)
                )
              }
          ...
          AnimationParser.prototype = {
                      ...
                      if (
                        ...
                        if (layerCurveNodes[i] === undefined) {
                          ...
                          if ('PreRotation' in rawModel)
                            node.preRotations = rawModel.PreRotation.value
                          if ('PostRotation' in rawModel)
                            node.postRotations = rawModel.PostRotation.value
                        ...
                        if (layerCurveNodes[i] === undefined) {
                          ...
                          var morpherID = connections.get(deformerID).parents[0]
                            .ID
            ...
            generateTracks: function generateTracks(rawTracks) {
              ...
              initialRotation = new THREE.Euler()
                .setFromQuaternion(initialRotation)
                .toArray() // todo: euler order
            ...
            generateVectorTrack: function generateVectorTrack(
              modelName,
              curves,
              initialValue,
              type
              ...
              var values = this.getKeyframeTrackValues(
                times,
                curves,
                initialValue
              )
            ...
            generateRotationTrack: function generateRotationTrack(
              modelName,
              curves,
              initialValue,
              preRotations,
              ...
              if (postRotations !== undefined) {
                ...
                postRotations = new THREE.Quaternion()
                  .setFromEuler(postRotations)
                  .inverse()
              }
              ...
              for (var i = 0; i < values.length; i += 3) {
                ...
                if (preRotations !== undefined)
                  quaternion.premultiply(preRotations)
                if (postRotations !== undefined)
                  quaternion.multiply(postRotations)
            ...
            getKeyframeTrackValues: function getKeyframeTrackValues(
              times,
              curves,
              initialValue
            ) {
          ...
          TextParser.prototype = {
            ...
            parseNodeProperty: function parseNodeProperty(
              line,
              property,
              contentLine
            ) {
            ...
            parseNodePropertyContinued: function parseNodePropertyContinued(
              line
            ) {
              var currentNode = this.getCurrentNode()
            ...
            // parse "Property70"
            parseNodeSpecialProperty: function parseNodeSpecialProperty(
              line,
              propName,
              propValue
            ) {
          ...
          function generateTransform(transformData) {
            ...
            var order = transformData.eulerOrder
              ? getEulerOrder(transformData.eulerOrder)
              : getEulerOrder(0)

            if (transformData.translation)
              translation.fromArray(transformData.translation)
            if (transformData.rotationOffset)
              translation.add(tempVec.fromArray(transformData.rotationOffset))
            ...
            if (transformData.scale)
              transform.scale(tempVec.fromArray(transformData.scale))
          ...
          function convertArrayBufferToString(buffer, from, to) {
            ...
            return THREE.LoaderUtils.decodeText(
      ...
      function (require, module, exports) {
        ...
        ;(vg.Board = function (e, t) {
          ...
          ;(this.tiles = []),
            ...
            (this.grid = null),
            (this.overlay = null),
            (this.finder = new vg.AStarFinder(t)),
            vg.Loader.init(),
            this.setGrid(e)
        }),
          (vg.Board.prototype = {
            ...
            removeAllTiles: function removeAllTiles() {
              if (this.tileGroup)
                for (
                  var e = this.tileGroup.children, t = 0;
                  t < e.length;
                  t++
                ) {
            ...
            getTileAtCell: function getTileAtCell(e) {
              ...
              return (
                e.tile ||
                ('undefined' != typeof this.grid.cells[t]
                  ? this.grid.cells[t].tile
                  : null)
              )
            },
          ...
          (vg.HexGrid = function (e) {
            ;(e = e || {}),
              (this.type = vg.HEX),
              (this.size = 5),
              (this.cellSize =
                'undefined' == typeof e.cellSize ? 10 : e.cellSize),
              (this.cells = {}),
              (this.numCells = 0),
            ...
            this.cellShape.lineTo(i[0].x, i[0].y),
              ...
              (this._cellLength = 0.5 * vg.SQRT3 * this._cellWidth),
              (this._hashDelimeter = '.'),
              (this._directions = [
                new vg.Cell(1, -1, 0),
                new vg.Cell(1, 0, -1),
          ...
          (vg.HexGrid.prototype = {
            ...
            getNeighbors: function getNeighbors(e, t, i) {
              ...
              for (this._list.length = 0, s = 0; l > s; s++) {
                this._cel.copy(e),
                  ...
                  !n || (i && !i(e, n)) || this._list.push(n)
              }
              if (t)
                for (s = 0; l > s; s++) {
                  this._cel.copy(e),
                    this._cel.add(this._diagonals[s]),
                    (n = this.cells[this.cellToHash(this._cel)]),
                    !n || (i && !i(e, n)) || this._list.push(n)
                }
              return this._list
            ...
            generateTile: function generateTile(e, t, i) {
              ...
              n ||
                ((this.extrudeSettings.amount = s),
                (n = new THREE.ExtrudeGeometry(
                  this.cellShape,
            ...
            generateTiles: function generateTiles(e) {
              ...
              for (s in this.cells) {
                ;(l = this.cells[s]),
                  (n = this.generateTile(l, i.tileScale, i.material)),
                  n.position.copy(this.cellToPixel(l)),
                  (n.position.y = 0),
                  t.push(n)
              }
              return t
            ...
            generateTilePoly: function generateTilePoly(e) {
              ...
              return (
                ...
                t.rotateOnAxis(this._vec3, vg.PI / 2),
                t
              )
            },
                ...
                for (i = -this.size; i < this.size + 1; i++) {
                  ;(s = -t - i),
                    Math.abs(t) <= this.size &&
                      ...
                      ((n = new vg.Cell(t, i, s)), this.add(n))
                }
              }
            },
            generateOverlay: function generateOverlay(e, t, i) {
              ...
              for (s = -e; e + 1 > s; s++) {
                for (n = -e; e + 1 > n; n++) {
                  if (
                    ((l = -s - n),
                    Math.abs(s) <= e && Math.abs(n) <= e && Math.abs(l) <= e)
                  ) {
                    this._cel.set(s, n, l)
                    var h = new THREE.Line(r, i)
                    h.position.copy(this.cellToPixel(this._cel)),
                      (h.rotation.x = 90 * vg.DEG_TO_RAD),
                      t.add(h)
                  }
                }
              }
            ...
            generateOverlay: function generateOverlay(e, t, i) {
              ...
              for (s = -l; l > s; s++) {
                for (n = -l; l > n; n++) {
                  ...
                  r.position.copy(this.cellToPixel(this._cel)),
                    (r.rotation.x = 90 * vg.DEG_TO_RAD),
                    t.add(r)
                }
              }
            },
          ...
          (vg.Tile = function (e) {
            ...
            if (((t = vg.Tools.merge(t, e)), !t.cell || !t.geometry))
            ...
            ;(t.generateID = function () {
              ...
              (t.prototype = {
                ...
                sort: function sort(e) {
                  ...
                  for (
                    this.clear(), s.sort(e), i = s.length, t = 0;
                    i > t;
                    t++
                  ) {
                    this.add(s[t])
          ...
          (function () {
            ...
            ;(t.prototype = {
              ...
              _registerListener: function _registerListener(t, i, s, n) {
                ...
                if (-1 !== r) {
                  if (((l = this._bindings[r]), l.isOnce !== i))
                    throw new Error(
                      'You cannot add' +
                        (i ? '' : 'Once') +
                        '() then add' +
          ...
          (vg.AStarFinder.prototype = {
            findPath: function findPath(e, t, i, s) {
              ...
              for (
                ...
                for (
                  r = s.getNeighbors(n, this.allowDiagonal, i),
                    o = 0,
                    a = r.length;
                  a > o;
                  o++
            ...
            expandPath: function expandPath(e) {
              ...
              for (l = 0; o - 1 > l; ++l) {
                for (
                  t = e[l],
                    i = e[l + 1],
                    s = this.interpolate(t[0], t[1], i[0], i[1]),
                    n = s.length,
                    r = 0;
                  n - 1 > r;
                  ++r
        ...
        ;(function (global) {
          ...
          if (0) {
            mergeIf(keyCodeToInfoTable, 'chrome-win', {
              ...
              0xdf: {
                code: 'Backquote',
                keyCap: '`', // [USB: 0x35] `~ (US Standard 101)
              },
            })
      ...
      function (require, module, exports) {
        ...
        ;(e.computeCentroids = function (e) {
          ...
          (e.mergeVertexIds = function (e, t) {
            ...
            if (
              ...
              return []
            n.includes(e[0]) &&
              n.includes(e[e.length - 1]) &&
              e.push(e.shift()),
              n.includes(t[0]) &&
                n.includes(t[t.length - 1]) &&
                t.push(t.shift()),
              (n = []),
              e.forEach(function (e) {
          ...
          (e.cleanPolygon = function (e, t) {
            for (
              var n = [], r = t.vertices, o = 0;
              o < e.vertexIds.length;
              o++
            ) {
              var i,
                s,
              ...
              0 === o
                ...
                : ((i = e.vertexIds[o + 1]), (s = e.vertexIds[o - 1])),
                (u = r[s])
          ...
          (e.isConvex = function (e, t) {
            ...
            for (var r = !0, o = [], i = 0; i < e.vertexIds.length; i++) {
              ...
              0 === i
                ? ((s = n[e.vertexIds[1]]),
                  (u = n[e.vertexIds[e.vertexIds.length - 1]]))
                : i === e.vertexIds.length - 1
                ? ((s = n[e.vertexIds[0]]),
                  (u = n[e.vertexIds[e.vertexIds.length - 2]]))
                : ((s = n[e.vertexIds[i + 1]]), (u = n[e.vertexIds[i - 1]]))
              var h = s.clone().sub(c),
                a = u.clone().sub(c),
                d = h.angleTo(a)
          ...
          (e.isPointInPoly = function (e, t) {
            for (var n = !1, r = -1, o = e.length, i = o - 1; ++r < o; i = r)
              ((e[r].z <= t.z && t.z < e[i].z) ||
                (e[i].z <= t.z && t.z < e[r].z)) &&
                t.x <
                  ((e[i].x - e[r].x) * (t.z - e[r].z)) / (e[i].z - e[r].z) +
                    e[r].x &&
                (n = !n)
            return n
          }),
        ...
        ;(t.prototype.push = function (e) {
          ...
          (t.prototype.remove = function (e) {
            ...
            t !== this.content.length - 1 &&
              ((this.content[t] = n),
              this.scoreFunction(n) < this.scoreFunction(e)
                ? this.sinkDown(t)
                : this.bubbleUp(t))
          }),
          ...
          (t.prototype.bubbleUp = function (e) {
            for (
              ...
              var o = (e + 1) << 1,
                ...
                u = void 0
              if (i < t)
                (u = this.scoreFunction(this.content[i])) < r && (s = i)
              if (o < t)
                this.scoreFunction(this.content[o]) < (null === s ? r : u) &&
                  (s = o)
              if (null === s) break
        ...
        ;(n.init = function (e) {
          ...
          (n.search = function (e, t, n) {
            ...
            for (r.push(t); r.size() > 0; ) {
              ...
              o.closed = !0
              for (
                var u = this.neighbours(e, o), c = 0, h = u.length;
                c < h;
                c++
              ) {
                var a = u[c]
                if (!a.closed) {
                  ...
                  if (!f || d < a.g) {
                    if (
                      ((a.visited = !0),
                      (a.parent = o),
                      !a.centroid || !n.centroid)
                    )
                      throw new Error('Unexpected state')
                    ;(a.h = a.h || this.heuristic(a.centroid, n.centroid)),
                      (a.g = d),
                      (a.f = a.g + a.h),
                      f ? r.rescoreElement(a) : r.push(a)
                  }
                }
              }
            }
        ...
        ;(o.buildZone = function (t) {
          ...
          r.vertices.forEach(function (t) {
            ;(t.x = e.roundNumber(t.x, 2)),
              (t.y = e.roundNumber(t.y, 2)),
              (t.z = e.roundNumber(t.z, 2))
          }),
          ...
          return (
            i.forEach(function (t) {
              ...
              t.forEach(function (o) {
                ...
                ;(o.centroid.x = e.roundNumber(o.centroid.x, 2)),
                  (o.centroid.y = e.roundNumber(o.centroid.y, 2)),
                  (o.centroid.z = e.roundNumber(o.centroid.z, 2)),
                  r.push({
                    id: s(t, o),
                    neighbours: i,
          ...
          (o._buildPolygonsFromGeometry = function (e) {
            ...
            e.faces.forEach(function (e) {
              n.push({
                ...
                s.get(e.a).add(n.length - 1),
                s.get(e.b).add(n.length - 1),
                s.get(e.c).add(n.length - 1)
            })
            var c = { polygons: n, vertices: o, faceVertexUvs: i }
            return (
        ...
        ;(i.prototype.push = function (e, t) {
          ...
          (i.prototype.stringPull = function () {
            ...
            return (
              (0 !== i.length &&
                e.vequal(i[i.length - 1], o[o.length - 1].left)) ||
        ...
        ;(f.createZone = function (e) {
          ...
          (f.prototype.getGroup = function (t, n) {
            ...
            var r = null,
              o = Math.pow(50, 2)
            return (
              this.zones[t].groups.forEach(function (t, i) {
          ...
          (f.prototype.getRandomNode = function (t, n, r, o) {
            ...
            return (
              this.zones[t].groups[n].forEach(function (t) {
                r && o
                  ? e.distanceToSquared(r, t.centroid) < o * o &&
                    i.push(t.centroid)
                  : i.push(t.centroid)
              }),
          ...
          (f.prototype.getClosestNode = function (t, n, r, o) {
            ...
            var i = this.zones[n].vertices,
              ...
              u = Infinity
            return (
              this.zones[n].groups[r].forEach(function (n) {
                var r = e.distanceToSquared(n.centroid, t)
                r < u &&
                  (!o || e.isVectorInPolygon(t, n, i)) &&
                  ((s = n), (u = r))
              }),
              s
            )
          ...
          (f.prototype.clampStep =
            ...
            function (e, t, n, r, o, i) {
              ...
              for (var g = v.pop(); g; g = v.pop()) {
                a.set(f[g.vertexIds[0]], f[g.vertexIds[1]], f[g.vertexIds[2]]),
                  a.closestPointToPoint(t, c),
                  c.distanceToSquared(t) < u &&
                    ((s = g), d.copy(c), (u = c.distanceToSquared(t)))
                var x = p[g]
                if (!(x > 2))
                  for (var I = 0; I < g.neighbours.length; I++) {
      ...
      function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent('gamepad-controls', {
          ...
          isVelocityActive: function isVelocityActive() {
            ...
            return (
              Math.abs(inputX) > JOYSTICK_EPS || Math.abs(inputY) > JOYSTICK_EPS
            )
          },
          ...
          updateRotation: function updateRotation(dt) {
            ...
            var hasLookControls =
              lookControls && lookControls.pitchObject && lookControls.yawObject
          ...
          getGamepad: (function () {
            ...
            return function (handPreference) {
              ...
              for (var i = 0; i < this.system.controllers.length; i++) {
                ...
                if (xrGamepad && xrGamepad.handedness === handPreference)
                  return xrGamepad
              }
          ...
          tick: (function () {
            ...
            return function (t, dt) {
              ...
              if (
                ...
                var nav = el.sceneEl.systems.nav
                this.navGroup =
                  this.navGroup === null ? nav.getGroup(start) : this.navGroup
          ...
          updateVelocityCtrl: function updateVelocityCtrl() {
            ...
            if (data.enabled) {
              for (var i = 0, l = data.controls.length; i < l; i++) {
                var control = this.el.components[
                  data.controls[i] + COMPONENT_SUFFIX
                ]
                ...
                self.model.traverse(function (object) {
                  if (object.isMesh) {
                    ...
                    if (material.emissiveMap)
                      rendererSystem.applyColorCorrection(material.emissiveMap)
                  }
                })
    ...
    25: [
      function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent('checkpoint', {
          ...
          fire: function fire() {
            var targetEl = this.el.sceneEl.querySelector(
              '[checkpoint-controls]'
            )
            if (!targetEl) {
          ...
          update: function update(oldData) {
            ...
            if (data.materials.length) {
              if (oldData.materials) {
                ...
                removedMaterialNames = oldData.materials.filter(function (
                  name
                ) {
            ...
            if (
              ...
              var maintainedMaterialNames = data.materials.filter(function (
                name
              ) {
                return oldData.materials.includes(name)
              })
  ...
  ——————————————————————————————————————————————*/
          ...
          beginJump: function beginJump() {
            if (this.numJumps < this.data.maxJumps) {
              var data = this.data,
                initialVelocity = Math.sqrt(
                  -2 * data.distance * (ACCEL_G + EASING)
                ),
        ...
        module.exports = AFRAME.registerComponent('kinematic-body', {
          ...
          step: (function () {
            ...
            return function (t, dt) {
              ...
              for (var i = 0, contact; (contact = contacts[i]); i++) {
                ...
                if (didCollide && currentSurfaceNormal.y <= 0.5) {
                  ...
                  if (height > groundHeight) {
                    ...
                    groundBody =
                      body.id === contact.bi.id ? contact.bj : contact.bi
                  }
                }
              }
              ...
              if (
                groundBody &&
                (!data.enableJumps || normalizedVelocity.y < 0.5)
              ) {
                if (!data.enableSlopes) {
                  groundNormal.set(0, 1, 0)
                } else if (groundNormal.y < 1 - EPS) {
                  groundNormal.copy(
                    this.raycastToGround(groundBody, groundNormal)
                  )
                }
                ...
                velocity.add(
                  this.system.driver.world.gravity.scale((dt * 4.0) / 1000)
                )
              }
          ...
          raycastToGround: function raycastToGround(groundBody, groundNormal) {
            ...
            return Math.abs(hitNormal.y) > Math.abs(groundNormal.y)
              ? hitNormal
              : groundNormal
          },
        })
        ...
        module.exports = AFRAME.registerComponent('nav-agent', {
          ...
          tick: (function () {
            ...
            return function (t, dt) {
              ...
              var intersections = raycaster.intersectObject(
      ...
      function (require, module, exports) {
        ...
        module.exports = AFRAME.registerComponent('nav-mesh', {
          ...
          loadNavMesh: function loadNavMesh() {
            ...
            var navMeshGeometry = navMesh.geometry.isBufferGeometry
