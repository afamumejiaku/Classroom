!(function e(t, i, n) {
...
})(
  {
          ...
          (function () {
            function e(e) {
              ...
              if ('Video' in e.Objects) {
                ...
                for (var o in n) {
                  var r = n[o]
                  if (((t[(l = parseInt(o))] = r.Filename), 'Content' in r)) {
                    var s =
                        r.Content instanceof ArrayBuffer &&
                        r.Content.byteLength > 0,
                      a = 'string' == typeof r.Content && '' !== r.Content
                    if (s || a) {
                      var c = (function (e) {
                        var t,
                          i = e.Content,
                          n = e.RelativeFilename || e.Filename,
                          o = n.slice(n.lastIndexOf('.') + 1).toLowerCase()
                        switch (o) {
                          case 'bmp':
                            t = 'image/bmp'
                            break
                  ...
                  var a = (function (e, t, i, n) {
                    var o = (function (e, t, i, n) {
                      ...
                      void 0 !== s &&
                        s.length > 0 &&
                        void 0 !== i[s[0].ID] &&
                        ((0 !== (o = i[s[0].ID]).indexOf('blob:') &&
                          0 !== o.indexOf('data:')) ||
                          t.setPath(void 0))
                      var a = t.load(o)
                      return t.setPath(r), a
                    })(e, t, i, n)
                    ;(o.ID = e.id), (o.name = e.attrName)
                    var r = e.WrapModeU,
                      s = e.WrapModeV,
                  ...
                  var c = (function (e, t, i, n) {
                    ...
                    var l,
                      h = (function (e, t, i, n, o) {
                        var s = {}
                        t.BumpFactor && (s.bumpScale = t.BumpFactor.value)
                        t.Diffuse &&
                          (s.color = new THREE.Color().fromArray(
                            t.Diffuse.value
                          ))
                        t.DisplacementFactor &&
                          (s.displacementScale = t.DisplacementFactor.value)
                        t.ReflectionFactor &&
                          (s.reflectivity = t.ReflectionFactor.value)
                        t.Specular &&
                          (s.specular = new THREE.Color().fromArray(
                            t.Specular.value
                          ))
                        t.Shininess && (s.shininess = t.Shininess.value)
                        t.Emissive &&
                          (s.emissive = new THREE.Color().fromArray(
                            t.Emissive.value
                          ))
                        t.EmissiveFactor &&
                          (s.emissiveIntensity = parseFloat(
                            t.EmissiveFactor.value
                          ))
                        t.Opacity && (s.opacity = parseFloat(t.Opacity.value))
                        s.opacity < 1 && (s.transparent = !0)
                        return (
                          o.get(n).children.forEach(function (t) {
                            var n = t.relationship
                            switch (n) {
                              case 'Bump':
                                s.bumpMap = i.get(t.ID)
                                break
                              case 'DiffuseColor':
                                s.map = r(e, i, t.ID, o)
                                break
                              case 'DisplacementColor':
                                s.displacementMap = r(e, i, t.ID, o)
                                break
                              case 'EmissiveColor':
                                s.emissiveMap = r(e, i, t.ID, o)
                                break
                              case 'NormalMap':
                                s.normalMap = r(e, i, t.ID, o)
                                break
                              case 'ReflectionColor':
                                ;(s.envMap = r(e, i, t.ID, o)),
                                  (s.envMap.mapping =
                                    THREE.EquirectangularReflectionMapping)
                                break
                              case 'SpecularColor':
                                s.specularMap = r(e, i, t.ID, o)
                                break
                              case 'TransparentColor':
                                ;(s.alphaMap = r(e, i, t.ID, o)),
                                  (s.transparent = !0)
                                break
                              case 'AmbientColor':
                    ...
                    switch (c.toLowerCase()) {
                      ...
                      default:
                        console.warn(
                          ...
                          (l = new THREE.MeshPhongMaterial({ color: 3342591 }))
                    }
                    return l.setValues(h), (l.name = a), l
                  })(e, s[a], t, i)
                  null !== c && n.set(parseInt(a), c)
                }
              }
              return n
            }
            ...
            function s(e, t) {
              ...
              if ('Deformer' in e.Objects) {
                ...
                for (var o in n) {
                  if ('Skin' === n[o].attrType) {
                    var r = t.get(parseInt(o)),
                      s = (function (e, t) {
                        var i = []
                        return (
                          e.children.forEach(function (e) {
                            ...
                            if ('Cluster' === n.attrType) {
                              ...
                              'Indexes' in n &&
                                ((o.indices = n.Indexes.a),
                                (o.weights = n.Weights.a)),
                                i.push(o)
                            }
                          }),
                          { rawBones: i, bones: [] }
                    ...
                    switch (i.attrType) {
                      case 'Mesh':
                        return (function (e, t, i, n) {
                          ...
                          var r = t.children.reduce(function (e, t) {
                              return void 0 !== n[t.ID] && (e = n[t.ID]), e
                            }, null),
                            s = new THREE.Matrix4(),
                            a = o[0]
                          if ('GeometricRotation' in a) {
                            var l = a.GeometricRotation.value.map(
                              THREE.Math.degToRad
                            )
                            ;(l[3] = 'ZYX'),
                              s.makeRotationFromEuler(
                          ...
                          'GeometricTranslation' in a &&
                            s.setPosition(
                              new THREE.Vector3().fromArray(
                                a.GeometricTranslation.value
                              )
                            )
                          return (function (e, t, i, n, o) {
                            var r = i.Vertices.a,
                              s = i.PolygonVertexIndex.a,
                              a = [],
                              l = [],
                              h = [],
                              u = [],
                            ...
                            if (i.LayerElementColor)
                              ...
                              })(i.LayerElementColor[0])
                            if (i.LayerElementMaterial)
                              var m = (function (e) {
                                var t = e.MappingInformationType,
                                  i = e.ReferenceInformationType
                              ...
                              })(i.LayerElementMaterial[0])
                            if (i.LayerElementNormal)
                              var y = (function (e) {
                                var t = e.MappingInformationType,
                                  i = e.ReferenceInformationType,
                                  n = e.Normals.a,
                              ...
                              })(i.LayerElementNormal[0])
                            if (i.LayerElementUV)
                              for (var g = [], E = 0; i.LayerElementUV[E]; )
                                g.push(
                                  (function (e) {
                                    var t = e.MappingInformationType,
                                      i = e.ReferenceInformationType,
                            ...
                            null !== n &&
                              n.rawBones.forEach(function (e, t) {
                                e.indices.forEach(function (i, n) {
                                  void 0 === b[i] && (b[i] = []),
                                    b[i].push({ id: t, weight: e.weights[n] })
                                })
                              })
                            var w = 0,
                              T = 0,
                            ...
                            s.forEach(function (e, t) {
                              ...
                              if (n) {
                                ...
                                for (; E.length < 4; ) E.push(0), o.push(0)
                                for (H = 0; H < 4; ++H)
                                  M.push(E[H]), A.push(o[H])
                              }
                              if (y) {
                                var O = c(t, w, e, y)
                                C.push(O[0], O[1], O[2])
                              }
                              if (m && 'AllSame' !== m.mappingType)
                                var _ = c(t, w, e, m)[0]
                              if (
                                (g &&
                                ...
                                for (var H = 2; H < T; H++)
                                  a.push(r[x[0]]),
                                    ...
                                    v &&
                                      ...
                                      h.push(S[3 * H + 2])),
                                    m &&
                                      'AllSame' !== m.mappingType &&
                                      (d.push(_), d.push(_), d.push(_)),
                                    y &&
                                      (l.push(C[0]),
                                      l.push(C[1]),
                                      l.push(C[2]),
                            ...
                            D.name = i.name
                            var L = new THREE.Float32BufferAttribute(a, 3)
                            o.applyToBufferAttribute(L),
                              D.addAttribute('position', L),
                              h.length > 0 &&
                                D.addAttribute(
                                  'color',
                            ...
                            n &&
                              (D.addAttribute(
                                'skinIndex',
                                new THREE.Float32BufferAttribute(f, 4)
                              ),
                              D.addAttribute(
                                'skinWeight',
                                new THREE.Float32BufferAttribute(p, 4)
                              ),
                              (D.FBX_Deformer = n))
                            if (l.length > 0) {
                              var O = new THREE.Float32BufferAttribute(l, 3)
                              new THREE.Matrix3()
                                .getNormalMatrix(o)
                                .applyToBufferAttribute(O),
                                D.addAttribute('normal', O)
                            }
                            if (
                              (u.forEach(function (e, t) {
                                ...
                                0 === t && (i = 'uv'),
                                  D.addAttribute(
                                    i,
                                    new THREE.Float32BufferAttribute(u[t], 2)
                                  )
                              }),
                              m && 'AllSame' !== m.mappingType)
                            ) {
                              var _ = d[0],
                                H = 0
                              if (
                                (d.forEach(function (e, t) {
                                  e !== _ &&
                                    (D.addGroup(H, t - H, _), (_ = e), (H = t))
                                }),
                                D.groups.length > 0)
                              ) {
                                var N = D.groups[D.groups.length - 1],
                                  I = N.start + N.count
                                I !== d.length && D.addGroup(I, d.length - I, _)
                              }
                              0 === D.groups.length &&
                                D.addGroup(0, d.length, d[0])
                            }
                            return D
                          })(0, 0, i, r, s)
                        })(e, t, i, n)
                      case 'NurbsCurve':
                        return (function (e) {
                          ...
                          for (
                            ...
                            o.push(new THREE.Vector4().fromArray(r, s))
                          var c, l
                          if ('Closed' === e.Form) o.push(o[0])
                          else if ('Periodic' === e.Form) {
                            ;(c = i), (l = n.length - 1 - c)
                            for (s = 0; s < i; ++s) o.push(o[s])
                          }
                          var h = new THREE.NURBSCurve(i, n, o, c, l).getPoints(
                              7 * o.length
                            ),
            ...
            function c(e, t, i, n) {
              return k[n.mappingType][n.referenceType](e, t, i, n)
            }
            function l(e, t, i, n, o) {
                      ...
                      u = (function (e, t, i, n) {
                        ...
                        return (
                          e.parents.forEach(function (e) {
                            for (var r in t) {
                              var s = t[r]
                              s.rawBones.forEach(function (t, r) {
                                if (t.ID === e.ID) {
                                  var a = o
                                  ;(o = new THREE.Bone()).matrixWorld.copy(
                                    t.transformLink
                                  ),
                                    (o.name = THREE.PropertyBinding.sanitizeNodeName(
                                      n
                                    )),
                                    (o.ID = i),
                                    (s.bones[r] = o),
                          ...
                          u = (function (e, t) {
                            ...
                            if (
                              (t.children.forEach(function (t) {
                                var i = e.Objects.NodeAttribute[t.ID]
                                void 0 !== i && (n = i)
                              }),
                              void 0 === n)
                            )
                              ...
                              var r = 1
                              void 0 !== n.NearPlane &&
                                (r = n.NearPlane.value / 1e3)
                              var s = 1e3
                              void 0 !== n.FarPlane &&
                                (s = n.FarPlane.value / 1e3)
                              var a = window.innerWidth,
                                c = window.innerHeight
                              void 0 !== n.AspectWidth &&
                                void 0 !== n.AspectHeight &&
                                ((a = n.AspectWidth.value),
                                (c = n.AspectHeight.value))
                              var l = a / c,
                                h = 45
                              void 0 !== n.FieldOfView &&
                                (h = n.FieldOfView.value)
                              var u = n.FocalLength ? n.FocalLength.value : null
                              switch (o) {
                                case 0:
                        ...
                        case 'Light':
                          u = (function (e, t) {
                            ...
                            if (
                              ...
                              var o
                              o = void 0 === n.LightType ? 0 : n.LightType.value
                              var r = 16777215
                              void 0 !== n.Color &&
                                (r = new THREE.Color().fromArray(n.Color.value))
                              var s =
                                void 0 === n.Intensity
                                  ? 1
                                  : n.Intensity.value / 100
                              ...
                              void 0 !== n.FarAttenuationEnd &&
                                (a =
                                  ...
                                  0 === n.EnableFarAttenuation.value
                                    ? 0
                                    : n.FarAttenuationEnd.value / 1e3)
                              switch (o) {
                                case 0:
                                  i = new THREE.PointLight(r, s, a, 1)
                                  break
                                case 1:
                                  i = new THREE.DirectionalLight(r, s)
                                  break
                                case 2:
                                  var c = Math.PI / 3
                                  void 0 !== n.InnerAngle &&
                                    (c = THREE.Math.degToRad(
                                      n.InnerAngle.value
                                    ))
                                  var l = 0
                                  void 0 !== n.OuterAngle &&
                                    ...
                                    (l = Math.max(l, 1))),
                                    (i = new THREE.SpotLight(r, s, a, c, l, 1))
                                  break
                                default:
                                  console.warn(
                    ...
                    !(function (e, t, i) {
                      if ('RotationOrder' in i) {
                        var n = [
                          ...
                          o = parseInt(i.RotationOrder.value, 10)
                        o > 0 && o < 6
                          ? console.warn(
                      ...
                      'Lcl_Translation' in i &&
                        t.position.fromArray(i.Lcl_Translation.value)
                      if ('Lcl_Rotation' in i) {
                        var r = i.Lcl_Rotation.value.map(THREE.Math.degToRad)
                        r.push('ZYX'), t.rotation.fromArray(r)
                      }
                      'Lcl_Scaling' in i &&
                        t.scale.fromArray(i.Lcl_Scaling.value)
                      if ('PreRotation' in i) {
                        var s = i.PreRotation.value.map(THREE.Math.degToRad)
                        s[3] = 'ZYX'
                        var a = new THREE.Euler().fromArray(s)
                        a = new THREE.Quaternion().setFromEuler(a)
                        var c = new THREE.Quaternion().setFromEuler(t.rotation)
                        a.multiply(c), t.rotation.setFromQuaternion(a, 'ZYX')
                      }
                    })(0, u, l),
                      r.set(c, u)
                  }
              ...
              return (
                s.forEach(function (i) {
                  ...
                  !(function (e, t, i, n, o) {
                    if ('LookAtProperty' in i) {
                      n.get(t.ID).children.forEach(function (i) {
                        if ('LookAtProperty' === i.relationship) {
                          var n = e.Objects.Model[i.ID]
                          if ('Lcl_Translation' in n) {
                            var r = n.Lcl_Translation.value
                            void 0 !== t.target
                              ? (t.target.position.fromArray(r),
                                o.add(t.target))
                              : t.lookAt(new THREE.Vector3().fromArray(r))
                          }
                        }
                      })
                    }
                  ...
                  t.get(i.ID).parents.forEach(function (e) {
                    ...
                    null === i.parent && r.add(i)
                }),
                (function (e, t, i, n, o) {
                  var r = (function (e) {
                    var t = {}
                    if ('Pose' in e.Objects) {
                      var i = e.Objects.Pose
                      for (var n in i)
                        if ('BindPose' === i[n].attrType) {
                          var o = i[n].PoseNode
                          Array.isArray(o)
                            ? o.forEach(function (e) {
                                t[e.Node] = new THREE.Matrix4().fromArray(
                                  e.Matrix.a
                                )
                              })
                            : (t[o.Node] = new THREE.Matrix4().fromArray(
                                o.Matrix.a
                              ))
                        }
                    }
                  ...
                  for (var s in t) {
                    var a = t[s]
                    o.get(parseInt(a.ID)).parents.forEach(function (e) {
                      if (i.has(e.ID)) {
                        var t = e.ID
                        o.get(t).parents.forEach(function (e) {
                          if (n.has(e.ID)) {
                            n.get(e.ID).bind(
                              new THREE.Skeleton(a.bones),
                              r[e.ID]
                            )
                          }
                        })
                ...
                (function (e, t, i) {
                  i.animations = []
                  var n = (function (e, t) {
                    if (void 0 === e.Objects.AnimationCurve) return
                    var i = (function (e) {
                      var t = e.Objects.AnimationCurveNode,
                        i = new Map()
                      for (var n in t) {
                        var o = t[n]
                        if (null !== o.attrName.match(/S|R|T/)) {
                          var r = { id: o.id, attr: o.attrName, curves: {} }
                          i.set(r.id, r)
                        }
                      }
                      return i
                    ...
                    !(function (e, t, i) {
                      ...
                      for (var o in n) {
                        var r = {
                            id: n[o].id,
                            times: n[o].KeyTime.a.map(g),
                            values: n[o].KeyValueFloat.a,
                          },
                          s = t.get(r.id)
                        if (void 0 !== s) {
                          var a = s.parents[0].ID,
                            ...
                            l = ''
                          if (c.match(/X/)) l = 'x'
                          else if (c.match(/Y/)) l = 'y'
                          else {
                            if (!c.match(/Z/)) continue
                            l = 'z'
                          }
                          i.get(a).curves[l] = r
                        }
                    ...
                    var n = (function (e, t, i) {
                      ...
                      for (var r in n) {
                        var s = [],
                          a = t.get(parseInt(r))
                        if (void 0 !== a) {
                          a.children.forEach(function (n, o) {
                            if (i.has(n.ID)) {
                              var r = i.get(n.ID)
                              if (
                                void 0 !== r.curves.x ||
                                ...
                                if (void 0 === s[o]) {
                                  var a
                                  t.get(n.ID).parents.forEach(function (e) {
                                    void 0 !== e.relationship && (a = e.ID)
                                  })
                                  var c = e.Objects.Model[a.toString()],
                                    l = {
                                  ...
                                  'Lcl_Translation' in c &&
                                    (l.initialPosition =
                                      c.Lcl_Translation.value),
                                    'Lcl_Rotation' in c &&
                                      (l.initialRotation =
                                        c.Lcl_Rotation.value),
                                    'Lcl_Scaling' in c &&
                                      (l.initialScale = c.Lcl_Scaling.value),
                                    'PreRotation' in c &&
                                      (l.preRotations = c.PreRotation.value),
                                    (s[o] = l)
                                }
                                s[o][r.attr] = r
                              }
                    ...
                    return (function (e, t, i) {
                      var n = e.Objects.AnimationStack,
                        o = {}
                      for (var r in n) {
                        var s = t.get(parseInt(r)).children
                        s.length > 1 &&
                          console.warn(
                            'THREE.FBXLoader: Encountered an animation stack with multiple layers, this is currently not supported. Ignoring subsequent layers.'
                          )
                        var a = i.get(s[0].ID)
                        o[r] = { name: n[r].attrName, layer: a }
                      }
                      return o
                    })(e, t, n)
                  })(e, t)
                        ...
                        e.layer.forEach(function (e) {
                          t = t.concat(
                            (function (e) {
                              ...
                              if (
                                void 0 !== e.T &&
                                Object.keys(e.T.curves).length > 0
                              ) {
                                var i = h(
                                  e.modelName,
                                  e.T.curves,
                              ...
                              if (
                                void 0 !== e.R &&
                                Object.keys(e.R.curves).length > 0
                              ) {
                                var n = (function (e, t, i, n) {
                                  ...
                                  var o = d(t),
                                    r = u(o, t, i)
                                  void 0 !== n &&
                                    ((n = n.map(THREE.Math.degToRad)).push(
                                      'ZYX'
                                    ),
                                    (n = new THREE.Euler().fromArray(n)),
                                    (n = new THREE.Quaternion().setFromEuler(
                                      n
                                    )))
                                  for (
                                    ...
                                    a.set(r[l], r[l + 1], r[l + 2], 'ZYX'),
                                      s.setFromEuler(a),
                                      void 0 !== n && s.premultiply(n),
                                      s.toArray(c, (l / 3) * 4)
                              ...
                              if (
                                void 0 !== e.S &&
                                Object.keys(e.S.curves).length > 0
                              ) {
                                var o = h(
                                  e.modelName,
                                  e.S.curves,
                ...
                (function (e, t) {
                  if (
                    'GlobalSettings' in e &&
                    'AmbientColor' in e.GlobalSettings
                  ) {
                    var i = e.GlobalSettings.AmbientColor.value,
                      n = i[0],
                      o = i[1],
                      r = i[2]
                    if (0 !== n || 0 !== o || 0 !== r) {
                      var s = new THREE.Color(n, o, r)
                      t.add(new THREE.AmbientLight(s, 1))
                    }
                  }
                })(e, r),
                r
            ...
            function h(e, t, i, n) {
              var o = d(t),
                r = u(o, t, i)
              return new THREE.VectorKeyframeTrack(e + '.' + n, o, r)
            }
            function u(e, t, i) {
              var n = i,
                o = [],
            ...
            function w(e, t, i, n) {
              for (var o = i, r = 0; o < n; o++, r++) e[r] = t[o]
              return e
            }
            ;(t.exports = THREE.FBXLoader = function (e) {
              this.manager = void 0 !== e ? e : THREE.DefaultLoadingManager
            }),
              Object.assign(THREE.FBXLoader.prototype, {
                load: function (e, t, i, n) {
                  var o = this,
                    r = THREE.LoaderUtils.extractUrlBase(e),
                  ...
                  var h = (function (e) {
                      ...
                      'Connections' in e &&
                        e.Connections.connections.forEach(function (e) {
                          ...
                          var r = { ID: n, relationship: o }
                          t.get(i).parents.push(r),
                            t.has(n) || t.set(n, { parents: [], children: [] })
                          var s = { ID: i, relationship: o }
                          t.get(n).children.push(s)
                        })
                      return t
                    })(r),
                    u = e(r),
                    d = n(
                      ...
                      i(
                        r,
                        new THREE.TextureLoader(this.manager).setPath(o),
                        u,
                        h
                      ),
                      h
              ...
              k = {
                ByPolygonVertex: {
                  Direct: function (e, t, i, n) {
                    var o = e * n.dataSize,
                      r = e * n.dataSize + n.dataSize
                    return w(T, n.buffer, o, r)
                  },
                  IndexToDirect: function (e, t, i, n) {
                    var o = n.indices[e],
                      r = o * n.dataSize,
                      s = o * n.dataSize + n.dataSize
                    return w(T, n.buffer, r, s)
                  },
                },
                ByPolygon: {
                  Direct: function (e, t, i, n) {
                    var o = t * n.dataSize,
                      r = t * n.dataSize + n.dataSize
                    return w(T, n.buffer, o, r)
                  },
                  IndexToDirect: function (e, t, i, n) {
                    var o = n.indices[t],
                ...
                ByVertice: {
                  Direct: function (e, t, i, n) {
                    var o = i * n.dataSize,
                      r = i * n.dataSize + n.dataSize
                    return w(T, n.buffer, o, r)
                  },
                },
                AllSame: {
                  IndexToDirect: function (e, t, i, n) {
                    var o = n.indices[0] * n.dataSize,
                      r = n.indices[0] * n.dataSize + n.dataSize
                    return w(T, n.buffer, o, r)
                  },
                },
              }
            Object.assign(p.prototype, {
              ...
              Object.assign(f.prototype, {
                parse: function (e) {
                  ...
                  for (var n = new m(); !this.endOfContent(t); ) {
                ...
                parseNode: function (e, t) {
                  var i = {},
                    ...
                    r =
                      (t >= 7500 ? e.getUint64() : e.getUint32(), e.getUint8()),
                    s = e.getString(r)
                  if (0 === n) return null
                  for (var a = [], c = 0; c < o; c++)
                    ...
                    0 === s.indexOf('Lcl ') && (s = s.replace('Lcl ', 'Lcl_')),
                      ...
                      (r =
                        ...
                        0 === a.indexOf('Lcl_')
                          ...
                          : i.propertyList[4]),
                      (t[s] = { type: a, type2: c, flag: l, value: r })
                  } else
                    void 0 === t[i.name]
                      ? 'number' == typeof i.id
              ...
              Object.assign(v.prototype, {
                ...
                getString: function (e) {
                  ...
                  return (
                    n >= 0 && (t = t.slice(0, n)),
                    THREE.LoaderUtils.decodeText(t)
                  )
                },
              }),
    ...
    6: [
      function (e, t, i) {
        'use strict'
        ;(t.exports = THREE.PLYLoader = function (e) {
          ;(this.manager = void 0 !== e ? e : THREE.DefaultLoadingManager),
          ...
          (THREE.PLYLoader.prototype = {
            ...
            isASCII: function (e) {
              return 'ascii' === this.parseHeader(this.bin2str(e)).format
            },
            parse: function (e) {
              return e instanceof ArrayBuffer
                ? this.isASCII(e)
                  ? this.parseASCII(this.bin2str(e))
                  : this.parseBinary(e)
                : this.parseASCII(e)
            },
                ...
                return (
                  'list' === i.type
                    ? ((i.name = e[3]),
                      ...
                      (i.itemType = e[2]))
                    : (i.name = e[1]),
                  i.name in t && (i.name = t[i.name]),
                  i
                )
              }
              var i = '',
                n = 0,
                o = /ply([\s\S]*)end_header\s/.exec(e)
              null !== o && ((i = o[1]), (n = o[0].length))
              for (
                var r,
                  s,
                  a = { comments: [], elements: [], headerLength: n },
                  c = i.split('\n'),
                  l = void 0,
                  h = 0;
                h < c.length;
                ...
                if ('' !== (u = u.trim()))
                  switch (
                    ...
                    case 'format':
                      ;(a.format = s[0]), (a.version = s[1])
                      break
                    case 'comment':
                      a.comments.push(u)
                      break
                    case 'element':
                      void 0 !== l && a.elements.push(l),
                        ((l = Object()).name = s[0]),
                        (l.count = parseInt(s[1])),
                        (l.properties = [])
                      break
                    case 'property':
                      l.properties.push(t(s, this.propertyNameMapping))
                      break
                    default:
                      console.log('unhandled', r, s)
                  }
              }
              return void 0 !== l && a.elements.push(l), a
            },
            parseASCIINumber: function (e, t) {
              switch (t) {
                case 'char':
                case 'uchar':
                case 'short':
            ...
            parseASCIIElement: function (e, t) {
              for (
                var i = t.split(/\s+/), n = Object(), o = 0;
                o < e.length;
                o++
              )
                if ('list' === e[o].type) {
                  for (
                    var r = [],
                      s = this.parseASCIINumber(i.shift(), e[o].countType),
                      a = 0;
                    a < s;
                    a++
                  )
                    r.push(this.parseASCIINumber(i.shift(), e[o].itemType))
                  n[e[o].name] = r
                } else
                  n[e[o].name] = this.parseASCIINumber(i.shift(), e[o].type)
              return n
            },
            parseASCII: function (e) {
              var t,
                i = new THREE.Geometry(),
                n = this.parseHeader(e),
                o = ''
              null !== (t = /end_header\s([\s\S]*)$/.exec(e)) && (o = t[1])
              var r = o.split('\n'),
                s = 0,
                a = 0
              i.useColor = !1
              for (var c = 0; c < r.length; c++) {
                ...
                if ('' !== (l = l.trim())) {
                  ...
                  var h = this.parseASCIIElement(n.elements[s].properties, l)
                  this.handleElement(i, n.elements[s].name, h), a++
                }
              }
            ...
            postProcess: function (e) {
              if (e.useColor) {
                for (var t = 0; t < e.faces.length; t++)
                  e.faces[t].vertexColors = [
                    e.colors[e.faces[t].a],
                    e.colors[e.faces[t].b],
                    e.colors[e.faces[t].c],
                  ]
                e.elementsNeedUpdate = !0
              }
              return e.computeBoundingSphere(), e
            },
            handleElement: function (e, t, i) {
              if ('vertex' === t) {
                if (
                  (e.vertices.push(new THREE.Vector3(i.x, i.y, i.z)),
                ...
                var o = i.vertex_indices || i.vertex_index
                3 === o.length
                  ? e.faces.push(new THREE.Face3(o[0], o[1], o[2]))
                  : 4 === o.length &&
                    e.faces.push(
                      new THREE.Face3(o[0], o[1], o[3]),
                      new THREE.Face3(o[1], o[2], o[3])
                    )
              }
            },
            binaryRead: function (e, t, i, n) {
              switch (i) {
                case 'int8':
                case 'char':
                ...
                case 'int16':
                case 'short':
                  return [e.getInt16(t, n), 2]
                case 'uint16':
                case 'ushort':
                  return [e.getUint16(t, n), 2]
                case 'int32':
                case 'int':
                  return [e.getInt32(t, n), 4]
                case 'uint32':
                case 'uint':
                  return [e.getUint32(t, n), 4]
                case 'float32':
                case 'float':
                  return [e.getFloat32(t, n), 4]
                case 'float64':
                case 'double':
                  return [e.getFloat64(t, n), 8]
              }
            },
            binaryReadElement: function (e, t, i, n) {
              for (var o, r = Object(), s = 0, a = 0; a < i.length; a++)
                if ('list' === i[a].type) {
                  var c = [],
                    l = (o = this.binaryRead(e, t + s, i[a].countType, n))[0]
                  s += o[1]
                  for (var h = 0; h < l; h++)
                    (o = this.binaryRead(e, t + s, i[a].itemType, n)),
                      c.push(o[0]),
                      (s += o[1])
                  r[i[a].name] = c
                } else
                  (o = this.binaryRead(e, t + s, i[a].type, n)),
                    (r[i[a].name] = o[0]),
                    (s += o[1])
              return [r, s]
            },
            parseBinary: function (e) {
              for (
                var t,
                  i = new THREE.Geometry(),
                  n = this.parseHeader(this.bin2str(e)),
                  o = 'binary_little_endian' === n.format,
                  r = new DataView(e, n.headerLength),
                  s = 0,
                  a = 0;
                a < n.elements.length;
                a++
      ...
      function (e, t, i) {
          ...
          return new i(function (i, o) {
            var r = t.timeout || 5e3,
              ...
              c = setTimeout(function () {
                o(new Error('Script request to ' + e + ' timed out')), n(s)
              }, r),
              l = function (e) {
                clearTimeout(e)
              }
            a.addEventListener('load', function (e) {
              ...
              a.addEventListener('error', function (t) {
                o(new Error('Script request to ' + e + ' failed ' + t)),
                  l(c),
                  n(s)
              }),
              (function (e) {
        ...
        t.exports = function (e) {
          return (
            (e = e || {}),
            function (t, i) {
              return (i = i || {}), o(t, i, e.Promise || Promise)
            }
          )
        }
      },
      ...
      function (e, t, i) {
        ...
        ;(r.Board = function (e, t) {
          ...
          ;(this.tiles = []),
            ...
            (this.grid = null),
            (this.overlay = null),
            (this.finder = new r.AStarFinder(t)),
            r.Loader.init(),
            this.setGrid(e)
        }),
          (r.Board.prototype = {
            ...
            getRandomTile: function () {
              var e = r.Tools.randomInt(0, this.tiles.length - 1)
              return this.tiles[e]
            },
          ...
          (r.Board.prototype.constructor = r.Board),
          (r.Cell = function (e, t, i, n) {
            ;(this.q = e || 0),
              (this.r = t || 0),
              (this.s = i || 0),
              (this.h = n || 1),
              ...
              (this._visited = !1),
              (this._parent = null),
              (this.uniqueID = r.LinkedList.generateID())
          }),
          (r.Cell.prototype = {
            set: function (e, t, i) {
          ...
          (r.Cell.prototype.constructor = r.Cell),
          (r.HexGrid = function (e) {
            ;(e = e || {}),
              (this.type = r.HEX),
              (this.size = 5),
            ...
            this.cellShape.lineTo(i[0].x, i[0].y),
              ...
              (this._cellLength = 0.5 * r.SQRT3 * this._cellWidth),
              (this._hashDelimeter = '.'),
              (this._directions = [
                new r.Cell(1, -1, 0),
                new r.Cell(1, 0, -1),
              ...
              (this._cel = new r.Cell()),
              (this._conversionVec = new THREE.Vector3()),
              (this._geoCache = []),
              (this._matCache = [])
          }),
          (r.HexGrid.TWO_THIRDS = 2 / 3),
          (r.HexGrid.prototype = {
            ...
            pixelToCell: function (e) {
              var t = e.x * (r.HexGrid.TWO_THIRDS / this.cellSize),
                i = (-e.x / 3 + (r.SQRT3 / 3) * e.z) / this.cellSize
            ...
            getNeighbors: function (e, t, i) {
              var n,
                o,
                r = this._directions.length
              for (this._list.length = 0, n = 0; r > n; n++)
                this._cel.copy(e),
            ...
            getRandomCell: function () {
              var e,
                t = 0,
                i = r.Tools.randomInt(0, this.numCells)
              for (e in this.cells) {
            ...
            generateTilePoly: function (e) {
              ...
              return (
                this._vec3.set(1, 0, 0), t.rotateOnAxis(this._vec3, r.PI / 2), t
              )
            },
            generate: function (e) {
              ;(e = e || {}),
            ...
            generateOverlay: function (e, t, i) {
              ...
              for (n = -e; e + 1 > n; n++)
                for (o = -e; e + 1 > o; o++)
                  if (
                    ((s = -n - o),
                    Math.abs(n) <= e && Math.abs(o) <= e && Math.abs(s) <= e)
                  ) {
                    this._cel.set(n, o, s)
                    var c = new THREE.Line(a, i)
                    c.position.copy(this.cellToPixel(this._cel)),
                      (c.rotation.x = 90 * r.DEG_TO_RAD),
                      t.add(c)
                  }
            },
            add: function (e) {
            ...
            fromJSON: function (e) {
              ...
              for (
                ...
                (i = new r.Cell()).copy(n[t]), this.add(i)
            },
            toJSON: function () {
              var e,
                t,
          ...
          (r.HexGrid.prototype.constructor = r.HexGrid),
          (r.SqrGrid = function (e) {
            ;(e = e || {}),
              (this.type = r.SQR),
              (this.size = 5),
              (this.cellSize = void 0 === e.cellSize ? 10 : e.cellSize),
          ...
          (r.SqrGrid.prototype = {
            ...
            generate: function (e) {
              ...
              for (t = -o; o > t; t++)
                for (i = -o; o > i; i++) (n = new r.Cell(t, i + 1)), this.add(n)
            },
            generateOverlay: function (e, t, i) {
              var n,
                o,
          ...
          (r.SqrGrid.prototype.constructor = r.SqrGrid),
          (r.Tile = function (e) {
            e = e || {}
            var t = { cell: null, geometry: null, material: null }
            if (!(t = r.Tools.merge(t, e)).cell || !t.geometry)
            ...
            ;(this.cell = t.cell),
              ...
              (this.cell.tile = this),
              (this.uniqueID = r.Tools.generateID()),
              (this.geometry = t.geometry),
              (this.material = t.material),
              this.material ||
                (this.material = new THREE.MeshPhongMaterial({
                  color: r.Tools.randomizeRGB('30, 30, 30', 13),
                })),
              (this.objectType = r.TILE),
              (this.entity = null),
              (this.userData = {}),
              (this.selected = !1),
              ...
              (this.rotation.x = -90 * r.DEG_TO_RAD),
          ...
          (r.Tile.prototype.constructor = r.Tile),
          (function () {
            var e = function () {
              ;(this.first = null),
                (this.last = null),
              ...
              ((e.prototype = {
                ...
                sort: function (e) {
                  var t,
                    ...
                    n = this.sortArray,
                    o = this.first
                  for (n.length = 0; o; ) n.push(o.obj), (o = o.next)
          ...
          (function () {
            ...
            ;((t.prototype = {
              ...
              _registerListener: function (t, i, n, o) {
                var r,
                  s = this._indexOfListener(t, n)
                if (-1 !== s) {
                  if ((r = this._bindings[s]).isOnce !== i)
                    throw new Error(
                      'You cannot add' +
                        (i ? '' : 'Once') +
                        '() then add' +
                ...
                } else (r = new e(this, t, i, n, o)), this._addBinding(r)
                return (
                  this.memorize &&
                    this._prevParams &&
            ...
            findPath: function (e, t, i, n) {
              ...
              for (
                ...
                if (
                  ...
                  return r.PathUtil.backtrace(t)
                for (
                  l = 0,
                    h = (a = n.getNeighbors(o, this.allowDiagonal, i)).length;
                  h > l;
                  l++
                )
                  if (
                    (c = a[l]).walkable &&
                    ((s = o._calcCost + n.distance(o, c)),
          ...
          (r.AStarFinder.prototype.constructor = r.AStarFinder),
          (r.PathUtil = {
            ...
            expandPath: function (e) {
              ...
              for (r = 0; c - 1 > r; ++r)
                for (
                  t = e[r],
                    i = e[r + 1],
                    o = (n = this.interpolate(t[0], t[1], i[0], i[1])).length,
                    s = 0;
                  o - 1 > s;
                  ++s
                )
            ...
            smoothenPath: function (e, t) {
              var i,
                ...
                y = t[f - 1][0],
                g = t[f - 1][1]
              for (s = [[(i = v), (n = m)]], c = 2; f > c; ++c) {
                for (
                  o = (h = t[c])[0],
                    r = h[1],
                    u = this.interpolate(i, n, o, r),
                    p = !1,
                    l = 1;
                  l < u.length;
                  ++l
            ...
            compressPath: function (e) {
              ...
              for (
                ...
                (t = h),
                  ...
                  (d = (h = e[s][0]) - t),
                  (p = (u = e[s][1]) - i),
                  (p /= r = Math.sqrt(d * d + p * p)),
                  ((d /= r) !== n || p !== o) && a.push([t, i])
              return a.push([h, u]), a
            },
          }),
          (r.Loader = {
          ...
          (r.MouseCaster.OVER = 'over'),
          (r.MouseCaster.OUT = 'out'),
          (r.MouseCaster.DOWN = 'down'),
          (r.MouseCaster.UP = 'up'),
          (r.MouseCaster.CLICK = 'click'),
          (r.MouseCaster.WHEEL = 'wheel'),
          (r.MouseCaster.prototype = {
            update: function () {
              if (this.active) {
            ...
            _onDocumentMouseUp: function (e) {
              return (
                ...
                this._preventDefault
                  ...
                  : ((this.shift = e.shiftKey),
                    (this.ctrl = e.ctrlKey),
                    this.signal.dispatch(r.MouseCaster.UP, this.pickedObject),
                    this.selectedObject &&
                      this.pickedObject &&
            ...
            _onMouseWheel: function (e) {
              if (this.active) {
                ...
                void 0 !== e.wheelDelta
                  ...
                  this.signal.dispatch(r.MouseCaster.WHEEL, this.wheel)
              }
            },
          }),
          (r.MouseCaster.prototype.constructor = r.MouseCaster),
          (r.Scene = function (e, t) {
            var i = {
            ...
            if (
              ((i = r.Tools.merge(i, e)),
              'boolean' != typeof t && (n = r.Tools.merge(n, t)),
          ...
          (r.SelectionManager = function (e) {
            ;(this.mouse = e),
              (this.onSelect = new r.Signal()),
              (this.onDeselect = new r.Signal()),
              (this.selected = null),
              (this.toggleSelection = !1),
              this.mouse.signal.add(this.onMouse, this)
          }),
          (r.SelectionManager.prototype = {
            select: function (e, t) {
              e &&
                ((t = t || !0),
            ...
            onMouse: function (e, t) {
              switch (e) {
                case r.MouseCaster.DOWN:
                  t || this.clearSelection()
                  break
                case r.MouseCaster.CLICK:
                  this.select(t)
              }
            },
          }),
          (r.SelectionManager.prototype.constructor = r.SelectionManager),
          (r.Tools = {
            ...
            radixSort: function (e, t, i, n) {
              if (
                ...
                for (var o = t, r = i, s = 1 << n; r > o; )
                  if (e[o] & s) {
                    --r
                    var a = e[o]
                    ;(e[o] = e[r]), (e[r] = a)
                  } else ++o
                this.radixSort(e, t, r, n - 1), this.radixSort(e, r, i, n - 1)
              }
            },
            randomizeRGB: function (e, t) {
              ...
              for (t = this.randomInt(t), i = 0; 3 > i; i++)
                0 > (n = parseInt(o[i]) + t) ? (n = 0) : n > 255 && (n = 255),
                  (r += n + ',')
    ...
    10: [
      function (e, t, i) {
        ...
        !(function (e) {
            ...
            var t = 'keyCode' in e ? e.keyCode : 'which' in e ? e.which : 0,
              i = (function () {
                if (g || 'keyLocation' in e) {
                  var i = g ? e.location : e.keyLocation
          ...
          var r = window.KeyboardEvent.DOM_KEY_LOCATION_STANDARD,
          ...
          i(d, 'moz', {
            ...
            i(d, 'ios', { 10: { code: 'Enter', location: r } }),
            i(d, 'safari-mac', {
              91: { code: 'OSLeft', location: s },
          ...
          i(v, 'mac', { OSLeft: { key: 'Meta' }, OSRight: { key: 'Meta' } })
          var m = {
              Esc: 'Escape',
          ...
          try {
            var g = o && 'location' in new KeyboardEvent('')
          } catch (e) {}
          'KeyboardEvent' in e &&
            ...
            (function () {
              ...
              if (
                ...
                Object.defineProperty(KeyboardEvent.prototype, 'key', {
                  get: function () {
                    ...
                    return m.hasOwnProperty(e) ? m[e] : e
                  },
                })
              }
              e(KeyboardEvent.prototype, 'key', {
                ...
                e(KeyboardEvent.prototype, 'location', {
                  get: function () {
                    var e = n(this)
                    return e && 'location' in e ? e.location : r
                  },
                }),
            ...
            'queryKeyCap' in e.KeyboardEvent ||
              (e.KeyboardEvent.queryKeyCap = function (e, t) {
                if (((e = String(e)), !y.hasOwnProperty(e))) return 'Undefined'
    ...
    12: [
        ...
        t.exports = AFRAME.registerComponent('gamepad-controls', {
          ...
          getVelocityDelta: function () {
            var e = this.getDpad(),
              ...
              o = new THREE.Vector3()
            return (
              Math.abs(i) > 0.2 && (o.x += i),
              Math.abs(n) > 0.2 && (o.z += n),
              o
            )
          },
          ...
          updateRotation: function (e) {
            if (this.isRotationActive()) {
              var t = this.data,
                ...
                r = o && o.pitchObject && o.yawObject
              r &&
                (n.rotation.copy(o.pitchObject.rotation),
                i.rotation.copy(o.yawObject.rotation))
              ...
              Math.abs(s.x) <= 0.2 && (s.x = 0),
                ...
                r &&
                  (o.pitchObject.rotation.copy(n.rotation),
                  o.yawObject.rotation.copy(i.rotation))
            }
          },
      ...
      { '../../lib/GamepadButton': 4, '../../lib/GamepadButtonEvent': 5 },
    ],
    13: [
      function (e, t, i) {
        'use strict'
      ...
      {
        './checkpoint-controls': 11,
        './gamepad-controls': 12,
        './keyboard-controls': 14,
        './movement-controls': 15,
        './touch-controls': 16,
        './trackpad-controls': 17,
      },
    ],
    14: [
      function (e, t, i) {
            ...
            return function (t) {
              ...
              if (o) {
                if (!o.getVelocityDelta) {
                  if (o.getVelocity) return void r.copy(o.getVelocity())
                  if (o.getPositionDelta)
                    return void r.copy(
                      o.getPositionDelta(t).multiplyScalar(1e3 / t)
                    )
                  throw new Error('Incompatible movement controls: ', o)
                }
                i = o.getVelocityDelta(t)
              }
              if (
                ...
                var a = s.camera
                i.applyQuaternion(a.object3D.quaternion)
                var c = i.length()
                s.fly
                  ? (r.copy(i), r.multiplyScalar(this.data.speed * t))
                  : (e.set(i.x, i.z),
                    e.setLength(c * this.data.speed * t),
                    (r.x = e.x),
                    (r.z = e.y))
              }
            }
      ...
      function (e, t, i) {
        ...
        t.exports = AFRAME.registerComponent('touch-controls', {
          ...
          onTouchStart: function (e) {
            ;(this.isMoving = !0), e.preventDefault()
          },
          onTouchEnd: function (e) {
            ;(this.isMoving = !1), e.preventDefault()
          },
        })
      },
      {},
    ...
    17: [
      function (e, t, i) {
        ...
        t.exports = AFRAME.registerComponent('trackpad-controls', {
          ...
          addEventListeners: function () {
            var e = this.el.sceneEl
            e.addEventListener('axismove', this.onAxisMove),
              e.addEventListener('trackpadtouchstart', this.onTouchStart),
              e.addEventListener('trackpadtouchend', this.onTouchEnd)
          },
          removeEventListeners: function () {
            var e = this.el.sceneEl
          ...
          onAxisMove: function (e) {
            var t = e.detail.axis
            t[1] < 0 && (this.zVel = 1), t[1] > 0 && (this.zVel = -1)
          },
        })
      },
      {},
      ...
      function (e, t, i) {
        ...
        t.exports = AFRAME.registerComponent('animation-mixer', {
          schema: {
            ...
            loop: { default: 'repeat', oneOf: Object.keys(o) },
          ...
          update: function (e) {
            e && (this.stopAction(), this.data.clip && this.playAction())
          },
          stopAction: function () {
            ...
            if (this.mixer) {
              ...
              if (i.length)
                for (
                  ...
                  if (r.name.match(s)) {
                    var c = this.mixer.clipAction(r, e)
                    ;(c.enabled = !0),
                      t.duration && c.setDuration(t.duration),
                      c
                        .setLoop(o[t.loop], t.repetitions)
      ...
      function (e, t, i) {
        ...
        t.exports = AFRAME.registerComponent('gltf-model-legacy', {
          ...
          init: function () {
            ...
            ;(this.model = null),
              (this.loader = null),
              (this.loaderPromise = o().then(function () {
    ...
    22: [
      function (e, t, i) {
        'use strict'
        t.exports = AFRAME.registerComponent('json-model', {
          schema: { src: { type: 'asset' }, crossorigin: { default: '' } },
          init: function () {
            this.model = null
          },
          update: function () {
            ...
            i.src &&
              ...
              t.load(i.src, function (t, i) {
                ...
                var n = (t.bones || []).length
                  ? new THREE.SkinnedMesh(t, new THREE.MultiMaterial(i))
                  : new THREE.Mesh(t, new THREE.MultiMaterial(i))
                e.load(n)
              }))
          },
          load: function (e) {
    ...
    24: [
      function (e, t, i) {
        'use strict'
        ;(THREE.PLYLoader = e('../../lib/PLYLoader')),
          (t.exports.System = AFRAME.registerSystem('ply-model', {
            init: function () {
              this.cache = {}
            },
            getOrLoadGeometry: function (e, t) {
              var i = this.cache,
                n = i[e]
              return !t && n
                ? n
                : ((i[e] = new Promise(function (t) {
                    new THREE.PLYLoader().load(e, function (e) {
                      t(e)
                    })
                  })),
                  i[e])
          ...
          (t.exports.Component = AFRAME.registerComponent('ply-model', {
            schema: {
            ...
            update: function () {
              ...
              e.src
                ? this.system
                    .getOrLoadGeometry(e.src, e.skipCache)
                    .then(function (e) {
                      var i = (function (e) {
                      ...
                      t.setObject3D('mesh', i),
                        t.emit('model-loaded', { format: 'ply', model: i })
                    })
        ...
        t.exports = AFRAME.registerComponent('cube-env-map', {
          ...
          update: function (e) {
            ...
            if (
              (t.materials.length &&
                (e.materials
                  ? ((o = t.materials.filter(function (t) {
                      return !e.materials.includes(t)
                    })),
                    (r = e.materials.filter(function (e) {
                      return !t.materials.includes(e)
                    })))
                  : (o = t.materials)),
              o.length && n(i, o, this.texture, t.reflectivity),
              r.length && n(i, r, null, 1),
      ...
      function (e, t, i) {
        ...
        t.exports = AFRAME.registerComponent('kinematic-body', {
          ...
          init: function () {
            ...
            var e = this.el,
              t = this.data,
              i = new CANNON.Vec3().copy(e.getAttribute('position'))
            ;(this.body = new CANNON.Body({
              ...
              this.body.addShape(
                ...
                new CANNON.Vec3(0, t.radius - t.height, 0)
              ),
          ...
          beforeStep: function (e, t) {
            if (t) {
              var i = this.el,
                n = this.body
              n.velocity.copy(i.getAttribute('velocity')),
                n.position.copy(i.getAttribute('position')),
                (n.position.y += this.data.userHeight)
            }
          },
          step: (function () {
            var e = new THREE.Vector3(),
            ...
            return function (o, r) {
              if (r) {
                ...
                ;(r = Math.min(r, 1e3 * this.system.data.maxInterval)),
                  n.set(0, 0, 0),
                ...
                if (
                  ...
                  h && t.y < 0.5
                    ? (a.enableSlopes
                        ...
                        : n.set(0, 1, 0),
                      (e = e.projectOnPlane(n)))
                    : this.system.driver.world &&
                      e.add(
                        this.system.driver.world.gravity.scale((4 * r) / 1e3)
                      ),
                  h && h.el && h.el.components.velocity)
                ) {
                  var f = h.el.getAttribute('velocity')
                  s.position.copy({
                    x: s.position.x + (f.x * r) / 1e3,
                    y: s.position.y + (f.y * r) / 1e3,
                    z: s.position.z + (f.z * r) / 1e3,
                  })
                }
                s.velocity.copy(e),
                  (s.position.y -= a.userHeight),
          ...
          raycastToGround: function (e, t) {
            var i = void 0,
              ...
              r = this.body.position.clone()
            return (
              (r.y -= this.data.height),
              (i = new CANNON.Ray(o, r))._updateDirection(),
              i.intersectBody(e),
              i.hasHit
        ...
        t.exports = AFRAME.registerComponent('sphere-collider', {
          ...
          tick: (function () {
            ...
            return function () {
              ...
              o.getObject3D('mesh') &&
                (n.clear(),
                e.copy(o.object3D.getWorldPosition()),
                o.object3D.getWorldScale(i),
                (a =
                  r.radius *
                  (function (e) {
                ...
                this.els.forEach(function (i) {
                  var o = void 0,
                    ...
                    u = void 0
                  i.isEntity &&
                    (r = i.getObject3D('mesh')) &&
                    ((u = (l = new THREE.Box3().setFromObject(r)).getSize()),
                    (h = Math.max(u.x, u.y, u.z) / 2),
                    (o = Math.sqrt(2 * h * h)),
                    l.getCenter(t),
                    o &&
                      (c = e.distanceTo(t)) < o + a &&
                      (s.push(i), n.set(i, c)))
                }),
                s
                  .sort(function (e, t) {
                    return n.get(e) > n.get(t) ? 1 : -1
                  })
                  .forEach(this.handleHit),
                0 === s.length && o.emit('hit', { el: null }),
                this.collisions
                  .filter(function (e) {
                    return !n.has(e)
                  })
        ...
        ;(t.exports.Primitive = AFRAME.registerPrimitive('a-ocean', {
          ...
          (t.exports.Component = AFRAME.registerComponent('ocean', {
            ...
            play: function () {
              ...
              for (var o, r = 0, s = n.vertices.length; r < s; r++)
                (o = n.vertices[r]),
                  this.waves.push({
                    z: o.z,
            ...
            tick: function (e, t) {
              if (t) {
                for (
                  var i, n, o = this.mesh.geometry.vertices, r = 0;
                  (i = o[r]);
                  r++
                )
                  (n = this.waves[r]),
                ...
                },
                {
                  ...
                  value: function (e, t, i) {
                    ...
                    for (n.push(t); n.size() > 0; ) {
                      var o = n.pop()
                      if (o === i) {
                        for (var r = o, s = []; r.parent; )
                          s.push(r), (r = r.parent)
                        return this.cleanUp(s), s.reverse()
                      }
                      o.closed = !0
                      for (
                        var a = this.neighbours(e, o), c = 0, l = a.length;
                        c < l;
                        c++
                      ) {
                        var h = a[c]
                        if (!h.closed) {
                          ...
                          if (!d || u < h.g) {
                            ...
                            ;(h.h =
                              h.h || this.heuristic(h.centroid, i.centroid)),
                              (h.g = u),
                              (h.f = h.g + h.h),
                  ...
                  value: function (e) {
                    for (
                      ...
                      if (r < t) {
                        ...
                        ;(a = this.scoreFunction(c)) < n && (s = r)
                      }
                      if (o < t) {
                        var l = this.content[o]
                        this.scoreFunction(l) < (null === s ? n : a) && (s = o)
                      }
                      if (null === s) break
              ...
              n(e, null, [
                {
                  ...
                  value: function (e) {
                    ...
                    i.vertices.forEach(function (e) {
                      ...
                      (n.vertices = i.vertices)
                    var r = this._buildPolygonGroups(i)
                    n.groups = []
                    var s = function (e, t) {
                    ...
                    return (
                      r.forEach(function (e) {
                        ...
                        e.forEach(function (n) {
                          var r = n.neighbours.map(function (t) {
                              return s(e, t)
                            }),
                            a = n.neighbours.map(function (e) {
                              return t._getSharedVerticesInOrder(n, e)
                            })
                          ;(n.centroid.x = o.roundNumber(n.centroid.x, 2)),
                            (n.centroid.y = o.roundNumber(n.centroid.y, 2)),
                            (n.centroid.z = o.roundNumber(n.centroid.z, 2)),
                            i.push({
                              id: s(e, n),
                              neighbours: r,
                    ...
                    return (
                      e.polygons.forEach(function (e) {
                        void 0 === e.group &&
                          ((e.group = i++),
                          (function e(t) {
                            t.neighbours.forEach(function (i) {
                              void 0 === i.group && ((i.group = t.group), e(i))
                            })
                          })(e)),
                          t[e.group] || (t[e.group] = []),
                          t[e.group].push(e)
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    e.neighbours = []
                    for (var i = 0, n = t.polygons.length; i < n; i++)
                      if (
                        e !== t.polygons[i] &&
                        !(
                          e.centroid.distanceToSquared(t.polygons[i].centroid) >
                          1e4
                        )
                      ) {
                        o.array_intersect(e.vertexIds, t.polygons[i].vertexIds)
                          .length >= 2 && e.neighbours.push(t.polygons[i])
                      }
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    var s = { polygons: i, vertices: n, faceVertexUvs: o }
                    return (
                      i.forEach(function (e) {
                        t._buildPolygonNeighbours(e, s)
                      }),
                      s
                    )
                  },
                  ...
                  value: function (e, t) {
                    ...
                    return (
                      ...
                      o.length < 2
                        ? []
                        : (o.includes(i[0]) &&
                            o.includes(i[i.length - 1]) &&
                            i.push(i.shift()),
                          o.includes(n[0]) &&
                            o.includes(n[n.length - 1]) &&
                            n.push(n.shift()),
                          (o.length = 0),
                          i.forEach(function (e) {
                            n.includes(e) && o.push(e)
              ...
              n(e, [
                {
                  ...
                  value: function (e, t) {
                    void 0 === t && (t = e),
                      this.portals.push({ left: e, right: t })
                  },
                },
                {
                  key: 'stringPull',
                  value: function () {
                    ...
                    for (var l = 1; l < e.length; l++) {
                      var h = e[l].left,
                        u = e[l].right
                      if (o.triarea2(i, r, u) <= 0) {
                        if (!(o.vequal(i, r) || o.triarea2(i, n, u) > 0)) {
                          t.push(n),
                            (n = i = n),
                            (r = i),
                            (a = s = a),
                      ...
                      if (o.triarea2(i, n, h) >= 0) {
                        if (!(o.vequal(i, n) || o.triarea2(i, r, h) < 0)) {
                          t.push(r),
                            (n = i = r),
                            (r = i),
                            (a = s = c),
    ...
    47: [
      function (e, t, i) {
              ...
              n(
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      ...
                      var i = null,
                        n = Math.pow(50, 2)
                      return (
                        this.zones[e].groups.forEach(function (e, r) {
                          e.forEach(function (e) {
                            var s = o.distanceToSquared(e.centroid, t)
                            s < n && ((i = r), (n = s))
                          })
                        }),
                        i
                    ...
                    value: function (e, t, i, n) {
                      ...
                      return (
                        this.zones[e].groups[t].forEach(function (e) {
                          i && n
                            ? o.distanceToSquared(i, e.centroid) < n * n &&
                              r.push(e.centroid)
                            : r.push(e.centroid)
                        }),
                        o.sample(r) || new THREE.Vector3()
                      )
                    },
                  },
                  {
                    ...
                    value: function (e, t, i) {
                      var n =
                          ...
                          void 0 !== arguments[3] &&
                          arguments[3],
                        r = this.zones[t].groups[i],
                        s = this.zones[t].vertices,
                        a = null,
                        c = 1 / 0
                      return (
                        r.forEach(function (t) {
                          var i = o.distanceToSquared(t.centroid, e)
                          i < c &&
                            (!n || o.isVectorInPolygon(e, t, s)) &&
                            ((a = t), (c = i))
                        }),
                        a
                      )
                  ...
                  },
                  {
                    key: 'findPath',
                    value: function (e, t, i, n) {
                      var o = this.zones[i].groups[n],
                        s = this.zones[i].vertices,
                        c = this.getClosestNode(e, i, n),
                        l = this.getClosestNode(t, i, n, !0)
                      if (!c || !l) return null
                      var h = r.search(o, c, l),
                        u = function (e, t) {
        ...
        c.prototype.clampStep = (function () {
          var e = new THREE.Vector3(),
            t = new THREE.Plane(),
            i = new THREE.Triangle(),
            n = void 0,
            o = new THREE.Vector3(),
            r = void 0
          return function (s, a, c, l, h, u) {
            var d = this.zones[l].vertices,
              p = this.zones[l].groups[h],
              f = [c],
              v = {}
            ;(v[c.id] = 0),
              (n = void 0),
              ...
              t.projectPoint(a, e),
              a.copy(e)
            for (var m = f.pop(); m; m = f.pop()) {
              i.set(d[m.vertexIds[0]], d[m.vertexIds[1]], d[m.vertexIds[2]]),
                i.closestPointToPoint(a, e),
                e.distanceToSquared(a) < r &&
                  ((n = m), o.copy(e), (r = e.distanceToSquared(a)))
              var y = v[m]
              if (!(y > 2))
                for (var g = 0; g < m.neighbours.length; g++) {
                  var E = p[m.neighbours[g]]
                  E.id in v || (f.push(E), (v[E.id] = y + 1))
                }
            }
            return u.copy(o), n
          }
      ...
      { './AStar': 43, './Builder': 45, './Channel': 46, './utils': 48 },
    ],
    48: [
      function (e, t, i) {
        'use strict'
            ...
            return (
              n(e, null, [
                ...
                },
                {
                  key: 'roundNumber',
                  value: function (e, t) {
                    var i = Number(e + '').toFixed(parseInt(t))
                    return parseFloat(i)
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    for (var n = i[1], o = i[0], r = e.slice(); r[0] !== n; )
                      r.push(r.shift())
                    for (var s = 0, a = t.slice(); a[0] !== o; )
                      if ((a.push(a.shift()), s++ > 10))
                        throw new Error('Unexpected state')
                    return a.shift(), a.pop(), (r = r.concat(a))
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    for (
                      ...
                      0 === o
                        ...
                        : ((r = e.vertexIds[o + 1]), (s = e.vertexIds[o - 1])),
                        (a = n[r]),
                        (c = n[s])
                      var h = a.clone().sub(l),
                        u = c.clone().sub(l),
                      ...
                      if (d > Math.PI - 0.01 && d < Math.PI + 0.01) {
                        ...
                        e.neighbours.forEach(function (t) {
                          t.vertexIds.includes(e.vertexIds[o]) || p.push(t)
                        }),
                          (e.neighbours = p)
                      } else i.push(e.vertexIds[o])
                    }
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (
                      ...
                      (n = arguments[e].length) < i && ((t = e), (i = n))
                    for (e = 0; e <= a; e++) {
                      o = arguments[(n = e === t ? 0 : e || t)].length
                      for (var c = 0; c < o; c++) {
                        var l = arguments[n][c]
                        s[l] === e - 1
                          ? e === a
