...
})(
  {
          ...
          AFRAME.registerComponent('super-hands', {
            ...
            init: function () {
              ;(this.HOVER_EVENT = 'hover-start'),
                ...
                (this.onStretchStartButton = this.onStretchStartButton.bind(
                  this
                )),
                ...
                (this.onDragDropEndButton = this.onDragDropEndButton.bind(
                  this
                )),
            ...
            remove: function () {
              this.system.unregisterMe(this),
                ...
                this.hoverEls.forEach((a) => {
                  a.removeEventListener('stateremoved', this.unWatch)
                }),
            ...
            onStretchStartButton: function (a) {
              ...
              b ||
                ((b = this.findTarget(this.STRETCH_EVENT, {
                  hand: this.el,
                  buttonEvent: a,
                })),
                b && (this.state.set(this.STRETCH_EVENT, b), this._unHover(b)))
            },
            onStretchEndButton: function (a) {
              const b = this.state.get(this.STRETCH_EVENT),
                c = { hand: this.el, buttonEvent: a }
              b &&
                !this.emitCancelable(b, this.UNSTRETCH_EVENT, c) &&
                (this.promoteHoveredEl(b),
            ...
            onDragDropStartButton: function (a) {
              ...
              ;(this.dragging = !0),
                ...
                b ||
                  ...
                  b && (this.state.set(this.DRAG_EVENT, b), this._unHover(b)))
            },
            onDragDropEndButton: function (a) {
              ...
              if (
                ...
                e &&
                  ...
                  this._unHover(e)),
                  this.emitCancelable(b, this.UNDRAG_EVENT, d) ||
                    (this.promoteHoveredEl(b),
            ...
            onHit: function (a) {
              ...
              var c = (a) => {
                let b
                ;(b = this.hoverEls.indexOf(a)),
                  -1 === b &&
                    (this.hoverEls.push(a),
                    a.addEventListener('stateremoved', this.unWatch),
              ...
              b && (Array.isArray(b) ? b.forEach(c) : c(b))
            },
            hover: function () {
              var a, b
              this.state.has(this.HOVER_EVENT) &&
                ...
                this.dragging &&
                  ...
                  b &&
                    (b.addEventListener('stateremoved', this.unHover),
                    this.emitCancelable(
                      this.state.get(this.DRAG_EVENT),
                      this.DRAGOVER_EVENT,
                      a
                ...
                this.state.has(this.DRAGOVER_EVENT) ||
                  ...
                  b &&
                    (b.addEventListener('stateremoved', this.unHover),
                    this.state.set(this.HOVER_EVENT, b)))
            },
            unHover: function (a) {
              const b = a.detail[this.data.colliderEndEventProperty]
              b
                ? Array.isArray(b)
                  ? b.forEach((a) => this._unHover(a))
                  : this._unHover(b)
                : a.detail.state === this.data.colliderState &&
                  this._unHover(a.target)
            },
            _unHover: function (a, b) {
              let c,
                d = !1
              a.removeEventListener('stateremoved', this.unHover),
                a === this.state.get(this.DRAGOVER_EVENT) &&
                ...
                a === this.state.get(this.HOVER_EVENT) &&
            ...
            unWatch: function (a) {
              ...
              b
                ? Array.isArray(b)
                  ? b.forEach((a) => this._unWatch(a))
                  : this._unWatch(b)
                : a.detail.state === this.data.colliderState &&
                  this._unWatch(a.target)
            },
            _unWatch: function (a) {
              var b = this.hoverEls.indexOf(a)
              a.removeEventListener('stateremoved', this.unWatch),
            ...
            unRegisterListeners: function (a) {
              ...
              0 === Object.keys(a).length ||
                (this.el.removeEventListener(a.colliderEvent, this.onHit),
            ...
            emitCancelable: function (a, b, c) {
              ...
              return (
                (c = c || {}),
                (d = { bubbles: !0, cancelable: !0, detail: c }),
                (d.detail.target = d.detail.target || a),
                (e = new window.CustomEvent(b, d)),
                a.dispatchEvent(e)
              )
            },
            dispatchMouseEvent: function (a, b, c) {
              var d = new window.MouseEvent(b, { relatedTarget: c })
              a.dispatchEvent(d)
            },
            dispatchMouseEventAll: function (a, b, c, d) {
              ...
              if (
                (c &&
                  (e = e.filter(
                    (a) =>
                      a !== this.state.get(this.GRAB_EVENT) &&
                      a !== this.state.get(this.DRAG_EVENT) &&
                      a !== this.state.get(this.STRETCH_EVENT) &&
                      !this.gehDragged.has(a)
                  )),
                d)
              )
            ...
            findTarget: function (a, b, c) {
              ...
              for (
                ...
                if (!this.emitCancelable(e[d], a, b)) return e[d]
              return null
            },
            promoteHoveredEl: function (a) {
              var b = this.hoverEls.indexOf(a)
              ;-1 !== b && (this.hoverEls.splice(b, 1), this.hoverEls.push(a))
            },
          })
      },
      {
        './misc_components/locomotor-auto-config.js': 2,
        './misc_components/progressive-controls.js': 3,
        './primitives/a-locomotor.js': 4,
        './reaction_components/clickable.js': 5,
        './reaction_components/drag-droppable.js': 6,
        './reaction_components/draggable.js': 7,
        './reaction_components/droppable.js': 8,
        './reaction_components/grabbable.js': 9,
        './reaction_components/hoverable.js': 10,
        './reaction_components/stretchable.js': 13,
        './systems/super-hands-system.js': 14,
      },
    ],
    2: [
      function (require, module, exports) {
        ...
        AFRAME.registerComponent('locomotor-auto-config', {
          ...
          init: function () {
            if (
              ...
              let a = document.createElement('a-camera')
          ...
          announceReady: function () {
            this.ready ||
              ((this.ready = !0), this.el.emit('locomotor-ready', {}))
          },
          fakeCollisions: function () {
            this.el.getChildEntities().forEach((a) => {
              let b = a.getAttribute('super-hands')
              if (b) {
                let c = {}
                ;(c[b.colliderEventProperty] = this.el),
                  a.emit(b.colliderEvent, c),
                  (this.colliderState = b.colliderState),
    ...
    3: [
      function (require, module, exports) {
        ...
        const gazeDefaultId = 'progressivecontrolsgazedefault',
          pointDefaultId = 'progressivecontrolspointdefault',
          touchDefaultId = 'progressivecontrolstouchdefault'
        AFRAME.registerComponent('progressive-controls', {
          ...
          init: function () {
            const a = AFRAME.components.link.schema.titleColor
              ? 'clearedEls'
              : 'el'
            ...
            const b =
              ...
              c = (this.gazeDefault = document.createElement('a-mixin')),
              d = AFRAME.utils.styleParser.stringify({
                colliderEvent: 'raycaster-intersection',
                colliderEventProperty: 'els',
                colliderEndEvent: 'raycaster-intersection-cleared',
                colliderEndEventProperty: a,
                colliderState: '',
              })
            c.setAttribute('id', gazeDefaultId),
              c.setAttribute(
                'geometry',
                'primitive: ring;radiusOuter: 0.008; radiusInner: 0.005; segmentsTheta: 32'
              ),
              c.setAttribute('material', 'color: #000; shader: flat'),
              c.setAttribute('position', '0 0 -0.5'),
              c.setAttribute('raycaster', ''),
              c.setAttribute('super-hands', d)
            const e = (this.pointDefault = document.createElement('a-mixin'))
            e.setAttribute('id', pointDefaultId),
              e.setAttribute('raycaster', 'showLine: true'),
              e.setAttribute('super-hands', d)
            const f = (this.touchDefault = document.createElement('a-mixin'))
            if (
              (f.setAttribute('id', touchDefaultId),
              f.setAttribute('super-hands', ''),
              f.setAttribute('sphere-collider', ''),
              this.el.sceneEl.getAttribute('physics'))
            ) {
              const a = 'shape: sphere; sphereRadius: 0.02'
              e.setAttribute('static-body', a),
                c.setAttribute('static-body', a),
                f.setAttribute('static-body', a)
            }
            b.appendChild(c),
              b.appendChild(e),
              b.appendChild(f),
              ...
              ['left', 'right'].forEach((a) => {
                this[a] =
                  this.el.querySelector('.' + a + '-controller') ||
                  this.el.appendChild(document.createElement('a-entity'))
                const b = { hand: a, model: this.data.controllerModel }
                ;[
                  'daydream-controls',
                  'gearvr-controls',
                ...
                ].forEach((c) => this[a].setAttribute(c, b))
              }),
              this.el.addEventListener('controllerconnected', (a) =>
                this.detectLevel(a)
              ),
          ...
          update: function () {
            const a = { objects: this.data.objects }
            updateMixin(this.gazeDefault, 'raycaster', a),
              updateMixin(this.pointDefault, 'raycaster', a),
              updateMixin(this.touchDefault, 'sphere-collider', a)
            for (let [a, b] of this.currentLevel)
              window.setTimeout(() => this.setLevel(b, a, !0))
          },
          remove: function () {
            if (this.eventsRegistered) {
              const a = this.el.sceneEl.canvas
              a.removeEventListener('mousedown', this.eventRepeaterB),
                a.removeEventListener('mouseup', this.eventRepeaterB),
                a.removeEventListener('touchstart', this.eventRepeaterB),
                a.removeEventListener('touchend', this.eventRepeaterB)
            }
          },
          setLevel: function (a, b, c) {
            b = b || 'right'
            const d = this.levels.indexOf(this.data.maxLevel),
              e = this[b],
              f = this.data.override
            if (((a = a > d ? d : a), a !== this.currentLevel.get(b) || c)) {
              switch (
                (0 !== a &&
                  this.caster &&
                ...
                case this.levels.indexOf('gaze'):
                  const c = this.data.gazeMixin
                  this.caster.setAttribute(
                    'mixin',
                    (f && c.length ? '' : gazeDefaultId + ' ') + c
                  )
                  break
                case this.levels.indexOf('point'):
                  const d = this.controllerName.get(b),
                    g = this.controllerConfig[d],
                    h = this.data.pointMixin
                  g && g.raycaster && e.setAttribute('raycaster', g.raycaster),
                    e.setAttribute(
                      'mixin',
                      (f && h.length ? '' : pointDefaultId + ' ') + h
                    )
                  break
                case this.levels.indexOf('touch'):
                  const i = this.data.touchMixin
                  e.setAttribute(
                    'mixin',
                    (f && i.length ? '' : touchDefaultId + ' ') + i
                  )
              }
              this.currentLevel.set(b, a),
          ...
          detectLevel: function (a) {
            const b = a.detail.component.data.hand || 'right'
            this.controllerName.set(b, a.detail.name),
              -1 ===
              [
                'vive-controls',
                'oculus-touch-controls',
                'windows-motion-controls',
              ].indexOf(a.detail.name)
                ? -1 !==
                    ['gearvr-controls', 'daydream-controls'].indexOf(
                      a.detail.name
                    ) && this.setLevel(this.levels.indexOf('point'), b)
                : this.setLevel(this.levels.indexOf('touch'), b)
          },
          eventRepeater: function (a) {
            !this.caster ||
              (a.type.startsWith('touch') &&
                (a.preventDefault(), 'touchmove' === a.type)) ||
              this.caster.emit(a.type, a.detail)
          },
          addEventListeners: function () {
            return this.el.sceneEl.canvas
              ? void (this.el.sceneEl.canvas.addEventListener(
                  'mousedown',
                  this.eventRepeaterB
                ),
              ...
              : void this.el.sceneEl.addEventListener(
                  'loaded',
          ...
          controllerConfig: {
            ...
            'oculus-touch-controls': {
              raycaster: {
                origin: { x: 1e-3, y: 0, z: 0.065 },
                direction: { x: 0, y: -0.8, z: -1 },
              },
            },
          },
        })
        function updateMixin(a, b, c) {
          const d = AFRAME.utils.styleParser.stringify,
            e = AFRAME.utils.extend,
            f = a.getAttribute(b)
          f && a.setAttribute(b, d(e(f, c)))
        }
      },
      {},
    ],
    4: [
      function (require, module, exports) {
        ...
        var extendDeep = AFRAME.utils.extendDeep,
          meshMixin = AFRAME.primitives.getMeshMixin()
    ...
    5: [
      function (require, module, exports) {
        ...
        AFRAME.registerComponent(
          'clickable',
          AFRAME.utils.extendDeep({}, buttonCore, {
            ...
            start: function (a) {
              this.startButtonOk(a) &&
                (this.el.addState(this.CLICKED_STATE),
                -1 === this.clickers.indexOf(a.detail.hand) &&
                  (this.clickers.push(a.detail.hand),
                  a.preventDefault && a.preventDefault()))
            },
            end: function (a) {
              const b = this.clickers.indexOf(a.detail.hand)
              this.endButtonOk(a) &&
                (-1 !== b && this.clickers.splice(b, 1),
                1 > this.clickers.length &&
      ...
      { './prototypes/buttons-proto.js': 11 },
    ],
    6: [
      function (require, module, exports) {
        'use strict'
    ...
    8: [
      function (require, module, exports) {
        ...
        AFRAME.registerComponent('droppable', {
          ...
          update: function () {
            ;(this.acceptableEntities = this.data.accepts.length
          ...
          hoverStart: function (a) {
            this.entityAcceptable(a.detail.carried) &&
              (this.el.addState(this.HOVERED_STATE),
              a.preventDefault && a.preventDefault())
          },
          hoverEnd: function () {
          ...
          dragDrop: function (a) {
            ...
            return this.entityAcceptable(b)
              ? void (this.data.acceptEvent.length &&
                  this.el.emit(this.data.acceptEvent, { el: b }),
                a.preventDefault && a.preventDefault())
              : void (
                  this.data.rejectEvent.length &&
                  this.el.emit(this.data.rejectEvent, { el: b })
                )
          },
        })
      },
    ...
    9: [
      function (require, module, exports) {
        ...
        AFRAME.registerComponent(
          'grabbable',
          inherit({}, physicsCore, buttonsCore, {
            schema: {
            ...
            init: function () {
              ;(this.GRABBED_STATE = 'grabbed'),
                ...
                this.physicsInit(),
                this.el.addEventListener(this.GRAB_EVENT, (a) => this.start(a)),
                this.el.addEventListener(this.UNGRAB_EVENT, (a) => this.end(a)),
                this.el.addEventListener('mouseout', (a) => this.lostGrabber(a))
            },
            update: function () {
              this.physicsUpdate(),
                ...
                (this.yFactor =
                  (this.data.invert ? -1 : 1) * !this.data.suppressY)
            },
            tick: function () {
              var a
              this.grabber &&
                ...
                this.deltaPositionIsValid
                  ? (this.deltaPosition.sub(this.targetPosition),
                    (a = this.el.getAttribute('position')),
                    (this.destPosition.x =
                      a.x - this.deltaPosition.x * this.xFactor),
                    (this.destPosition.y =
                      a.y - this.deltaPosition.y * this.yFactor),
                    (this.destPosition.z =
                      a.z - this.deltaPosition.z * this.zFactor),
              ...
              if (this.startButtonOk(a)) {
                ...
                if (-1 === this.grabbers.indexOf(a.detail.hand) && b) {
                  ...
                  this.grabbers.push(a.detail.hand),
                    this.physicsStart(a) ||
                      this.grabber ||
                      ((this.grabber = a.detail.hand), this.resetGrabber()),
                    a.preventDefault && a.preventDefault(),
                    (this.grabbed = !0),
            ...
            resetGrabber: function () {
              ...
              return (
                !!this.grabber &&
                ((a = this.grabber.getAttribute('raycaster')),
                (this.deltaPositionIsValid = !1),
                (this.grabDistance = this.el.object3D
                  .getWorldPosition()
                  .distanceTo(this.grabber.object3D.getWorldPosition())),
                a &&
                  ((this.grabDirection = a.direction),
                  (this.grabOffset = a.origin)),
                !0)
              )
            },
            lostGrabber: function (a) {
              let b = this.grabbers.indexOf(a.relatedTarget)
              ;-1 === b ||
                a.relatedTarget === this.grabber ||
                this.physicsIsConstrained(a.relatedTarget) ||
                this.grabbers.splice(b, 1)
            },
          })
        )
      ...
      {
        './prototypes/buttons-proto.js': 11,
        './prototypes/physics-grab-proto.js': 12,
      },
    ],
    10: [
      function (require, module, exports) {
        ...
        AFRAME.registerComponent('hoverable', {
          ...
          start: function (a) {
            this.el.addState(this.HOVERED_STATE),
              -1 === this.hoverers.indexOf(a.detail.hand) &&
                this.hoverers.push(a.detail.hand),
              a.preventDefault && a.preventDefault()
          },
          end: function (a) {
            var b = this.hoverers.indexOf(a.detail.hand)
            ;-1 !== b && this.hoverers.splice(b, 1),
              1 > this.hoverers.length &&
                this.el.removeState(this.HOVERED_STATE)
          },
        })
      },
        ...
        module.exports = {
          ...
          physicsStart: function (a) {
            if (
              ...
              this.el.body &&
              a.detail.hand.body &&
              !this.constraints.has(a.detail.hand)
            ) {
              let b = new window.CANNON.LockConstraint(
                this.el.body,
                a.detail.hand.body
              )
              return (
                this.el.body.world.addConstraint(b),
          ...
          physicsEnd: function (a) {
            let b = this.constraints.get(a.detail.hand)
            b &&
              (this.el.body.world.removeConstraint(b),
              this.constraints.delete(a.detail.hand))
          },
          physicsClear: function () {
            if (this.el.body)
              for (let a of this.constraints.values())
          ...
          inherit({}, buttonCore, {
            ...
            tick: function () {
              ...
              this.scale.copy(this.el.getAttribute('scale')),
                ...
                this.otherHandPos.copy(
                  this.stretchers[1].getAttribute('position')
                )
              const a = this.handPos.distanceTo(this.otherHandPos)
              let b = 1
              if (
                (null !== this.previousStretch &&
                  0 !== a &&
                  (b = Math.pow(
                    a / this.previousStretch,
                    this.data.invert ? -1 : 1
                  )),
                (this.previousStretch = a),
                this.scale.multiplyScalar(b),
                this.el.setAttribute('scale', this.scale),
                this.el.body && 'never' !== this.data.usePhysics)
              ) {
                var c = this.el.body.shapes[0]
                c.halfExtents
                  ? (c.halfExtents.scale(b, c.halfExtents),
                    c.updateConvexPolyhedronRepresentation())
                  : c.radius
                  ? ((c.radius *= b), c.updateBoundingSphereRadius())
                  : !this.shapeWarned &&
                    (console.warn(
            ...
            start: function (a) {
              this.stretched ||
                this.stretchers.includes(a.detail.hand) ||
                !this.startButtonOk(a) ||
              ...
              var b = this.stretchers.indexOf(a.detail.hand)
              this.endButtonOk(a) &&
                (-1 !== b &&
                  (this.stretchers.splice(b, 1),
                  (this.stretched = !1),
